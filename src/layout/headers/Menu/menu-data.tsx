    ...
    sub_menus: [
      {
        ...
        demo_img: service_demo_1,
      },
      {
        link: "/seo-audit",
        title: "SEO Audit Services",
        demo_img: service_demo_2,
      },
      {
        link: "/social-services",
        title: "Link Building Services",
        demo_img: service_demo_3,
      },
      {
        link: "/media-markiting",
        title: "Social Media Marketing",
        demo_img: service_demo_4,
      },
      {
        link: "/marketing-analysis",
        title: "SEO analysis.",
        demo_img: service_demo_5,
      },
    ],
    banner_sub_title: "SEO Agency",
    banner_title: (
      <>
        The #1 SEO <br /> agency for fast growing <br /> companies.
      </>
    ),
    icon: <RightArrowMenu />,
