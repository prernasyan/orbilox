...
const breadcrumb_content: breadcrumb_content_type = {
  top_title: "About Us",
  title: "About Us",
  sub_title: "Skyrocket Your Growth Beyond Your Orbit",
  inner_title: "Working Hard to Make Marketing Easy. Together",
  inner_info: (
    <>
      From local startups to growing enterprises, we help brands orbit their
      markets through tailored digital marketing, SEO, and website development
      services.
    </>
  ),
};
const { top_title, title, sub_title, inner_title, inner_info } =
  breadcrumb_content;
      ...
      <MouseParallaxContainer className="breadcrumb-about-area scene p-relative breadcrumb-bg">
        <div className="about-inner-shape">
          <MouseParallaxChild
            factorX={0.1}
            factorY={0.1}
            className="about-inner-shape-2 d-none d-md-block"
          >
            <Image
              className="layer"
              data-depth="0.5"
          ...
          <MouseParallaxChild
            factorX={0.1}
            factorY={0.1}
            className="about-inner-shape-3 d-none d-md-block"
          >
            <Image
              className="layer"
              data-depth="0.5"
        ...
        <MouseParallaxChild
          factorX={0}
          factorY={0.2}
          className="tpbanner-shape-y scene-y"
        >
