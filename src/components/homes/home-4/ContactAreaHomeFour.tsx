...
const { sub_title, title, sm_des, phone, email, cotact_shape } =
  contact_content;
        ...
        <div className="contact-shape d-none d-lg-block">
          {cotact_shape.map((item, i) => (
            <Image
              ...
              src={item.img}
              alt="theme-pure"
              className={`contact-shape-${item.id} ${item.cls}`}
            />
          ))}
        </div>
            ...
            <div className="col-lg-6">
              <div className="tpcontact-4 mt-30 mb-50">
                ...
                <div className="tpcontact-4-content">
                  <p>{sm_des}</p>
                  <a className="phone mb-5" href={`tel:${phone}`}>
                    {phone}
                  </a>
                  <a className="mail mb-35" href={`mailto:${email}`}>
                    {email}
                  </a>
