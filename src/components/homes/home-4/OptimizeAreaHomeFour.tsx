...
const OptimizeAreaHomeFour: React.FC<Props> = ({ service }) => {
  // optimize content
  const optimize_content: optimize_content_type = {
    sub_title: `Looking for best ${toTitleCase(service)} for your business ?`,
    title: (
      <>
        Organic Search <br /> Engine Optimisation
      </>
    ),
    sm_info: (
      <>
        So I said down the you owt to do with me absolutely bladdered, <br />{" "}
              ...
              <div className="optimize-wrapperp pt-35">
                ...
                <div className="tpdrive-progress mb-25 pr-150">
                  ...
                  <div className="tpdrive-bar-item yellow-bar">
                    <h4 className="tpdrive-bar-title mb-15">{skill}</h4>
                    <div className="tpdrive-bar-progress">
                      <div className="progress">
                        <div
                          className="progress-bar wow slideInLeft"
