          ...
          <div className="counter-bg-4 p-relative fix">
            <div className="counter-shape-4  d-none d-md-block">
              <Image
                src={counter_shape_1}
                alt="counter_shape_1"
                className="counter-shape-4-1"
              />
              <Image
                src={counter_shape_2}
                alt="counter_shape_2"
                className="counter-shape-4-2"
              />
              <Image
                src={counter_shape_3}
                alt="counter_shape_3"
                className="counter-shape-4-3"
              />
              <Image
                src={counter_shape_4}
                alt="counter_shape_4"
                className="counter-shape-4-4"
              />
              <Image
                src={counter_shape_5}
                alt="counter_shape_5"
                className="counter-shape-4-5"
              />
            </div>
              ...
              {counter_data.map((item, i) => (
                <div key={i} className="counter-item-4 d-flex">
                  ...
                  <div className="counter-item-4-content">
                    <div className="counter-item-4-count">
                      <span
