...
const PortfolioAreaHomeFour = () => {
  ...
  const [productItems, setProductItems] = useState<IPortfolio[]>([
  ...
  const handleCategory = (cate: string) => {
    ...
    if (cate === "All Work") {
      ...
      const filter_category = portfolio_items.filter(
        (p) => p.category.toLowerCase() === cate.toLowerCase()
      );
              ...
              <div className="portfolio-4-wrapper">
                ...
                <div className="portfolio-tab-4 mb-35">
                  <div className="nav flex-column nav-pills me-3">
                    {categories.map((tab_btn, i) => (
                      <button
                        key={i}
                        onClick={() => handleCategory(tab_btn)}
                        className={`nav-link ${
                          active === tab_btn ? "active" : ""
                        }`}
                      >
                        {tab_btn}
                      </button>
                ...
                <div className="nav-tab-slider-4">
                  <div className="tpnav-tab-4 p-relative">
                    <button
                      className="prv-testi-case prv-nav-tab"
                      onClick={handlePrev}
                    >
                      <span>
                        <svg
                    ...
                    <button
                      className="next-testi-case next-nav-tab"
                      onClick={handleNext}
                    >
                      <span>
                        <svg
              ...
              <div>
                <div>
                  <Slider
                    {...setting}
                    ref={sliderRef}
                    className="protfolio-wrapper-4 portfolio-4-active"
                  >
